...
printed in the failure report if the test fails.  If you have many
independent assertions you need to make and you don't want to invent
names for each individual one, this is the test definition syntax for
you.
...
either a string or a promise (as created by C<delay>) to produce a
